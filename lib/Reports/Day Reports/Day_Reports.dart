...
class DayReportsPage extends StatefulWidget {
  const DayReportsPage({super.key});

  @override
  State<DayReportsPage> createState() => _DayReportsScreenState();
}

class _DayReportsScreenState extends State<DayReportsPage> {
  String? selectedButton;

  int posTerminalCount = 0;
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        foregroundColor: selectedButton == 'Submit'
                            ? Colors.white
                            : Colors.black,
                        backgroundColor: selectedButton == 'Submit'
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Row(
                                  children: [
                                    Checkbox(
                                      value: isDateRangeSelected,
                                      onChanged: (bool? newValue) {
                                        setState(() {
                                          isDateRangeSelected = newValue!;
                                        });
                                      },
                                    ),
                                    const Text(
