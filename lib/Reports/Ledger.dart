...
class LedgerPage extends StatefulWidget {
  ...
  @override
  State<LedgerPage> createState() => _LedgerScreenState();
}

class _LedgerScreenState extends State<LedgerPage> {
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      items: ['Credit Balance', 'Credit Ledger']
                                  ...
                                  Expanded(
                                    ...
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      items: ["Silak", "All Silak", "HO Customer", "All HO Customer"]
                                          .map((type) => DropdownMenuItem(
                                        value: type,
                                        child: Text(type),
                                      ))
