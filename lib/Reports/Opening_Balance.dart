...
class OpeningBalancePage extends StatefulWidget {
  ...
  @override
  State<OpeningBalancePage> createState() => _OpeningBalanceScreenState();
}

class _OpeningBalanceScreenState extends State<OpeningBalancePage> {
