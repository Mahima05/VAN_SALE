...
class WastagePage extends StatefulWidget {
  ...
  @override
  State<WastagePage> createState() => _WastageScreenState();
}

class _WastageScreenState extends State<WastagePage> {
                          ...
                          Row(
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items: ['Accident Mortatality', 'Chilled Chicken Wastage','Daan Khata']
