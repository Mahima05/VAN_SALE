...
class ReceivingPage extends StatefulWidget{
  ...
  @override
  State<ReceivingPage> createState() => _ReceivingScreenState();
}
class _ReceivingScreenState extends State<ReceivingPage>{
                        ...
                        children: [
                          ...
                          Row(
                              children: [
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      items: ['LOT', 'IB ST', 'PO(Local Vendor)', 'Challan', 'None']
                                ...
                                // Choose Ref.PI/Order TextField and Select Button
                               Expanded(
                                  flex: 1,
                                  child: Row(
                                    children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        // Fourth row
                          ...
                          // Five Row: Add and Clear Buttons
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              SizedBox(
                          ...
                          SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: const Color.fromARGB(255, 170, 9, 9),
                                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 15),
                                            shape: RoundedRectangleBorder(
                                              borderRadius: BorderRadius.circular(10),
                                            ),
