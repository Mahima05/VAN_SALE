...
class FranchiseSaleReturn extends StatefulWidget{
  const FranchiseSaleReturn({super.key});
  @override
  State<FranchiseSaleReturn> createState() => _FranchiseSaleReturnScreenState();
}
class _FranchiseSaleReturnScreenState extends State<FranchiseSaleReturn>{
