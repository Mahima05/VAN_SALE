...
class GenMaterialIndentPage extends StatefulWidget{
  const GenMaterialIndentPage({super.key});
  @override
  State<GenMaterialIndentPage> createState() => _GenMaterialIndentScreenState();
}
class _GenMaterialIndentScreenState extends State<GenMaterialIndentPage>{
