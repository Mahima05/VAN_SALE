...
class StocktakePage extends StatefulWidget{
  ...
  @override
  State<StocktakePage> createState() => _StocktakeScreenState();
}
class _StocktakeScreenState extends State<StocktakePage>{
