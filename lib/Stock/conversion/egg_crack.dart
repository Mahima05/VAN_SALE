...
class EggCrackPage extends StatefulWidget{
  const EggCrackPage({super.key});
  @override
  State<EggCrackPage> createState() => _EggCrackScreenState();
}
class _EggCrackScreenState extends State<EggCrackPage>{
