...
class LiveStockAdjustPage extends StatefulWidget{
  const LiveStockAdjustPage({super.key});
  @override
  State<LiveStockAdjustPage> createState() => _LiveStockAdjustScreenState();
}
class _LiveStockAdjustScreenState extends State<LiveStockAdjustPage>{
