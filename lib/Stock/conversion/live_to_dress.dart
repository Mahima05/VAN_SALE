...
class LiveToDressPage extends StatefulWidget{
  const LiveToDressPage({super.key});
  @override
  State<LiveToDressPage> createState() => _LiveToDressScreenState();
}
class _LiveToDressScreenState extends State<LiveToDressPage>{
                              ...
                              const SizedBox(width: 10),
                                    ...
                                    SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: const Color.fromARGB(255, 152, 7, 7),
                                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 15),
                                            shape: RoundedRectangleBorder(
                                              borderRadius: BorderRadius.circular(10),
                                            ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    width: 300, // Optional: Specify a fixed width for the dropdown
                                    child: DropdownButtonFormField<String>(
                                      decoration: InputDecoration(
                                        labelText: 'Select Dress Item',
                                        border: OutlineInputBorder(
                                          borderRadius: BorderRadius.circular(10),
                                        ),
                                        contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
