...
class DemandForPPPage extends StatefulWidget{
  const DemandForPPPage({super.key});
  @override
  State<DemandForPPPage> createState() => _DemandForPPScreenState();
}
class _DemandForPPScreenState extends State<DemandForPPPage>{
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: ['HO', 'IB ST', 'Local Vendor', 'None']
