...
class ProductionPlanPage extends StatefulWidget{
  ...
  @override
  State<ProductionPlanPage> createState() => _ProductionPlanScreenState();
}
class _ProductionPlanScreenState extends State<ProductionPlanPage>{
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: DropdownButtonFormField<String>(
                                  decoration: InputDecoration(
                                    labelText: 'Choose Conversion Type',
                                    border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(5),
                                    ),
                                    contentPadding: const EdgeInsets.symmetric(
                          ...
                          Row(
                            children: [
                              Expanded(
                                flex: 2, // Adjust the proportion for the TextField width
                                child: TextField(
                                  decoration: InputDecoration(
                              ...
                              const SizedBox(width: 10), // Add spacing between TextField and Checkbox
                              Expanded(
                                flex: 1, // Adjust the proportion for the Checkbox width
                                child: Row(
                                  children: [
                                    Checkbox(
