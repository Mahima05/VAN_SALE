...
class PackagingPage extends StatefulWidget {
  ...
  @override
  State<PackagingPage> createState() => _PackagingScreenState();
}

class _PackagingScreenState extends State<PackagingPage> {
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              SizedBox(
                                width: 300,
                                // Optional: Specify a fixed width for the dropdown
                                child: DropdownButtonFormField<String>(
                                  decoration: InputDecoration(
