...
class GroupCompanySale extends StatefulWidget{
  const GroupCompanySale({super.key});
  @override
  State<GroupCompanySale> createState() => _GroupCompanySaleScreenState();
}
class _GroupCompanySaleScreenState extends State<GroupCompanySale>{
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color.fromARGB(255, 150, 10, 22),
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(10),
                                    ),
                                  ),
