...
class ConsignmentIssue extends StatefulWidget{
  const ConsignmentIssue({super.key});
  @override
  State<ConsignmentIssue> createState() => _ConsignmentIssueScreenState();
}
class _ConsignmentIssueScreenState extends State<ConsignmentIssue>{
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Row: Branch Name and Location Code
                Row(
                  children: [
                    Expanded(
                      child: TextField(
                ...
                Row(
                  ...
                  children: List.generate(
                    4, // Adjust the number of buttons as needed
                        (index) => Flexible(
                      flex: 1,
                      child: SizedBox(
                        height: 50, // Ensure square shape
                        width: double.infinity, // Fill the space equally
  ...
  void _showIndentSearchDialog(BuildContext context) {
    DateTime? startDate; // Variable to store the start date
    DateTime? endDate; // Variable to store the end date
                        ...
                        Expanded(
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              if (pickedDate != null) {
                                setState(() {
                                  startDate = pickedDate; // Update start date
                                });
                              }
                            },
                            child: Container(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: const [
                          BoxShadow(
                              color: Color.fromARGB(255, 235, 235, 235) // changes position of shadow
                          ),
                        ],
                      ),
                      child: Column(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              // Location TextField with Button
                              Expanded(
                                child: Row(
                                  children: [
                                    // Location TextField
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Delete Selected Row Button with 4 TextFields
                          Row(
                            children: [
                              // Delete Selected Row Button
                              ElevatedButton(
