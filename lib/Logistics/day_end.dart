...
class DayEndPage extends StatefulWidget{
  ...
  @override
  State<DayEndPage> createState() => _DayEndScreenState();
}

class _DayEndScreenState extends State<DayEndPage>{
  String? selectedButton;
  bool isSerialized = false;

  double menuFontSize = 14.0;
  FontWeight menuFontWeight = FontWeight.bold;
  String menuFontFamily = 'Times New Roman';

  double menubarFontSize = 20.0;
                               ...
                               const SizedBox(height: 10),
                                Row(
                                  children: [
                                    ...
                                    // Fourth TextField (after checkbox)
                                    Expanded(
                                      child: TextField(
                                        decoration: InputDecoration(
                                          labelText: 'Remarks',
