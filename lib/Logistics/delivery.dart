...
class DeliveryPage extends StatefulWidget{
  ...
  @override
  State<DeliveryPage> createState() => _DeliveryScreenState();
}

class _DeliveryScreenState extends State<DeliveryPage>{
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextField(
                                        decoration: InputDecoration(
                                          labelText: 'Odometer Reading(End)',
                                          border: OutlineInputBorder(
                                            borderRadius:
                                                BorderRadius.circular(10),
                                          ),
                              ...
                              const SizedBox(height: 10),
                               ...
                               Row(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(width: 10), // Spacing between button and text fields
                                      ...
                                      // Gross Weight TextField (Right Side)
                                      SizedBox(
                                        width: 150.0,
                                        child: TextField(
                                          decoration: InputDecoration(
