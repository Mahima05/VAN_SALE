...
class DayEndAttendancePage extends StatefulWidget {
  const DayEndAttendancePage({super.key});

  @override
  State<DayEndAttendancePage> createState() => _DayEndAttendanceScreenState();
}

class _DayEndAttendanceScreenState extends State<DayEndAttendancePage> {
