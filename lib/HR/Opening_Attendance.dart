...
class OpeningAttendancePage extends StatefulWidget {
  const OpeningAttendancePage({super.key});

  @override
  State<OpeningAttendancePage> createState() => _OpeningAttendanceScreenState();
}

class _OpeningAttendanceScreenState extends State<OpeningAttendancePage> {
