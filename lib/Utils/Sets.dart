...
class SetsPage extends StatefulWidget {
  ...
  @override
  State<SetsPage> createState() => _SetsScreenState();
}

class _SetsScreenState extends State<SetsPage> {
  String? selectedButton;

  bool isFreeItemEnabled = false;
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Row(
                                  children: [
                                    Checkbox(
                                      value: isFreeItemEnabled,
                                      onChanged: (bool? newValue) {
                                        setState(() {
                                          isFreeItemEnabled = newValue!;
                                        });
                                      },
                                    ),
                                    const Text(
