...
class DayEndUtilsPage extends StatefulWidget {
  const DayEndUtilsPage({super.key});

  @override
  State<DayEndUtilsPage> createState() => _DayEndUtilsScreenState();
}

class _DayEndUtilsScreenState extends State<DayEndUtilsPage> {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextField(
                              readOnly: true,
                              decoration: InputDecoration(
                                labelText: 'HO Customer Receivable',
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                                ),
                              ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextField(
                              readOnly: true,
                              decoration: InputDecoration(
                                labelText: 'Subscription Redemption',
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                                ),
                              ),
