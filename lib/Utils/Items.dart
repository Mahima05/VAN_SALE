...
class ItemsPage extends StatefulWidget {
  ...
  @override
  State<ItemsPage> createState() => _ItemsScreenState();
}

class _ItemsScreenState extends State<ItemsPage> {
  String? selectedButton;

  bool isSaleOfGroupItemSelected = false;
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Row(
                                  children: [
                                    Checkbox(
                                      value: isSaleOfGroupItemSelected,
                                      onChanged: (bool? newValue) {
                                        setState(() {
                                          isSaleOfGroupItemSelected = newValue!;
                                        });
                                      },
                                    ),
                                    const Text(
                                      "Allow Mix Sale Of Group Items",
                                      style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.bold),
                                    ),
