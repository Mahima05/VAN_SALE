...
class CartingChargesPage extends StatefulWidget {
  const CartingChargesPage({super.key});

  @override
  State<CartingChargesPage> createState() => _CartingChargesScreenState();
}

class _CartingChargesScreenState extends State<CartingChargesPage> {
                                ...
                                DataTableTheme(
                                  ...
                                  child: DataTable(
                                    columns: const [
                                      ...
                                      DataColumn(
                                        label: Text('FixedAmount'),
                                      ),
                                      DataColumn(
                                        label: Text('MinAmount'),
                                      ),
                                    ],
