...
class BatchLabelPage extends StatefulWidget {
  const BatchLabelPage({super.key});

  @override
  State<BatchLabelPage> createState() => _BatchLabelScreenState();
}

class _BatchLabelScreenState extends State<BatchLabelPage> {
