...
class DataSynchPage extends StatefulWidget {
  const DataSynchPage({super.key});

  @override
  State<DataSynchPage> createState() => _DataSynchScreenState();
}

class _DataSynchScreenState extends State<DataSynchPage> {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              children: [
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Location")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Vendors")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Customer")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("General Material")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Vehicle")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Employee")]),
                              ],
                            ),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              children: [
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Budget")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Place")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Bank Account")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Item/Material")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Conversion (BOM)")]),
                                Row(children: [Checkbox(value: false, onChanged: (value) {}), const Text("Carting Scheme")]),
                          ...
                          children: [
                                ...
                                Expanded(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: 'Pincode of the Place',
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                ...
                                // Forces content to start from the left
                                children: [
                                  DataTableTheme(
