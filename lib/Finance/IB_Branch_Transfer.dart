...
class IBBranchTransferPage extends StatefulWidget {
  const IBBranchTransferPage({super.key});

  @override
  State<IBBranchTransferPage> createState() => _IBBranchTransferScreenState();
}

class _IBBranchTransferScreenState extends State<IBBranchTransferPage> {
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: DropdownButtonFormField<String>(
                                        ...
                                        items: [
                                          '12300987666 ICICI Bank',
                                          '23114455667 State Bank of India',
                                          '4512899334 HDFC Bank',
                                          '1233546757 Axis Bank'
                                        ]
