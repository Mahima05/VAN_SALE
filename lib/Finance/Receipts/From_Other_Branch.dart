...
class FromOtherBranchPage extends StatefulWidget {
  const FromOtherBranchPage({super.key});

  @override
  State<FromOtherBranchPage> createState() => _FromOtherBranchScreenState();
}

class _FromOtherBranchScreenState extends State<FromOtherBranchPage> {
