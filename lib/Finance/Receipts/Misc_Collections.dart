...
class MiscCollectionPage extends StatefulWidget {
  const MiscCollectionPage({super.key});

  @override
  State<MiscCollectionPage> createState() => _MiscCollectionScreenState();
}

class _MiscCollectionScreenState extends State<MiscCollectionPage> {
